...
from multiprocessing import Queue, Value, Array, cpu_count
...
def run_sim(pr:Experiment2D, param_name, param_vars):
    """
...
class PSO_OptimizerMP():
    ...
    def optimize_pso(self, init_position=None):
        ...
        for i in range(self.n_particles):
            ...
            # pr = run_sim(self.pr, self.var_name, self.particle_position[i, :])
